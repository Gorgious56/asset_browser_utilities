...
def register():
    ...
    bpy.types.OUTLINER_MT_collection.append(draw_outliner_context_menu_appends)
    bpy.types.OUTLINER_MT_object.append(draw_outliner_context_menu_appends)
...
def unregister():
    ...
    bpy.types.OUTLINER_MT_collection.remove(draw_outliner_context_menu_appends)
    bpy.types.OUTLINER_MT_object.remove(draw_outliner_context_menu_appends)
